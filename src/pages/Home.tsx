    ...
    <div className="flex flex-col items-center">
      ...
      <div className="container mx-auto py-16 px-4">
        ...
        <div className="mt-12 text-center">
          <Button asChild className="bg-primary hover:bg-primary/90 hover-rotate text-lg px-8 py-6 h-auto">
...
// Custom Icon Components that match the Southwest theme
const MessageIcon = () => (
  <div className="w-12 h-12 text-primary flex items-center justify-center">
    <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M23 25H37" stroke="#8A3B12" strokeWidth="4" strokeLinecap="round" />
      <path d="M23 32H30" stroke="#8A3B12" strokeWidth="4" strokeLinecap="round" />
    </svg>
  </div>
);

const CactusIcon = () => (
  <div className="w-12 h-12 text-sage flex items-center justify-center">
    <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M30 15V45" stroke="#79A089" strokeWidth="4" strokeLinecap="round" />
      ...
      <path d="M30 35C30 32.2386 27.7614 30 25 30H22.5C19.7386 30 17.5 32.2386 17.5 35V45H30" 
        ...
        strokeLinecap="round" 
        strokeLinejoin="round" />
      <path d="M15 45H45" stroke="#79A089" strokeWidth="4" strokeLinecap="round" />
    </svg>
  </div>
);
...
const LockIcon = () => (
  <div className="w-12 h-12 text-sage flex items-center justify-center">
    <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
      <rect x="15" y="25" width="30" height="25" rx="4" stroke="#79A089" strokeWidth="4" fill="none" />
      <path d="M20 25V20C20 14.4772 24.4772 10 30 10C35.5228 10 40 14.4772 40 20V25" 
        stroke="#79A089" 
        strokeWidth="4" 
        strokeLinecap="round" />
      <path d="M30 35V40" stroke="#79A089" strokeWidth="4" strokeLinecap="round" />
    </svg>
  </div>
);
