 ...
 *
 * All fields are nullable because the metadata coming from Supabase
 * could be partially filled (or missing entirely) while we migrate
 * towards a dedicated `subscriptions` table.
 * /
